...
from xtuner.parallel.sequence import (
    pad_for_sequence_parallel, split_for_sequence_parallel, 
...
class Template:
    ...
    def _pad_and_split_for_sequence_parallel(self, tokenizer, input_ids, labels, position_ids, attention_mask, loss_scale):
